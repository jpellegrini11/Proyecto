...
@Named("chartEntPrueba")
@ViewScoped

public class ChartViewEntPrueba implements Serializable {
	...
	private Boolean bolMostrar= false;

	private boolean bolMostrar2= false;

	public ChartViewEntPrueba(){}
    ...
    public void mostrarString() {
    	System.out.println("mostrar StringCHart");
		String usuario = (String) SessionUtils.getRequest().getSession(false).getAttribute("usuario");
		Entrenador ent = new Entrenador();
		try {
			ent = entrenadorEjb.obtenerEntrenadorIgual(usuario);
			System.out.println("ent.getUsuDep()= "+ent.getUsuDep());
    ...
    public void mostrarGrafico() {
    	...
    	System.out.println("mostrarGrafico chartP");
    	String usuario = null;
		if(SessionUtils.getRequest().getRequestURI().contains("/ProyectoSGE_Cliente_Rest1/entrenador/")) {
    		...
    		System.out.println("else 1 mostGraf");
    		usuario = (String) SessionUtils.getRequest().getSession(false).getAttribute("usuario");
    	}
...
//	        		}
    	...
    	public void filtoDatosEnto(String usuario) {
    		...
    		System.out.println("Metodo filtoDatosEnto");
...
if(num.longValue()<numEnto.longValue()) {
	...
	public boolean isBolMostrar2() {
		return bolMostrar2;
	}

	public void setBolMostrar2(boolean bolMostrar2) {
		this.bolMostrar2 = bolMostrar2;
	}
}
